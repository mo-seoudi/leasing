...
const leasingLinks = [{ label: "Leasing Dashboard", path: "/leasing" }, { label: "Programme Directory", path: "/leasing/programmes" }, { label: "Performance Comparison", path: "/leasing/year-comparison" }];
const cateringLinks = [{ label: "Catering Dashboard", path: "/catering" }, { label: "Performance Comparison", path: "/catering/comparison" }];
...
function getPageDetails(pathname) {
  ...
  if (pathname === "/catering/comparison") return { section: "Catering", title: "Performance Comparison" };
  if (pathname === "/uniform") return { section: "Uniform", title: "Uniform Dashboard" };
  if (pathname === "/uniform/comparison") return { section: "Uniform", title: "Performance Comparison" };
  if (pathname === "/photography") return { section: "Photography", title: "Photography Dashboard" };
  if (pathname === "/photography/comparison") return { section: "Photography", title: "Performance Comparison" };
...
export default function PlatformLayout() {
  ...
  const isLeasingRoute = location.pathname === "/leasing" || location.pathname.startsWith("/leasing/");
  const isCateringRoute = location.pathname.startsWith("/catering");
  const isUniformRoute = location.pathname.startsWith("/uniform");
  ...
  const [cateringOpen, setCateringOpen] = useState(isCateringRoute);
  const [uniformOpen, setUniformOpen] = useState(isUniformRoute);
  ...
  useEffect(() => {
    ...
    if (isCateringRoute) setCateringOpen(true);
    if (isUniformRoute) setUniformOpen(true);

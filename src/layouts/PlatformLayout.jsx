...
function getPageDetails(p){
 const pages={
  "/dashboard":{section:"",title:"Commercial Overview"},"/reporting":{section:"",title:"Commercial Reporting"},"/suppliers":{section:"Workspace",title:"Supplier & Contract Register"},

...
export default function CateringDashboardPage() {
  ...
  if (loading) return <section className="catering-dashboard-page"><div className="dashboard-empty-state">Loading Catering data…</div></section>;
  if (loadError) return <section className="catering-dashboard-page"><div className="dashboard-empty-state">{loadError}</div></section>;
  ...
  return <section className="catering-dashboard-page">
    ...
    <MonthlyTrendChart data={monthlyData} formatAxis={formatCompactCurrency} tooltipContent={currencyTooltip} className="catering-wide-card" />

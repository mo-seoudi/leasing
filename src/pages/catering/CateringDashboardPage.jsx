...
export default function CateringDashboardPage() {
  ...
  const latestAcademicYear = cateringAcademicYears[cateringAcademicYears.length - 1] || "";
  ...
  const filteredRecords = useMemo(() => filterCateringRecords(filters), [filters]);
  ...
  return (
    <section className="catering-dashboard-page">
      ...
      <section className="catering-two-column-grid">
        <ChartCard title="School Performance" description="Sales and commission by school.">
          <DashboardBarChart
            data={schoolData}
            categoryKey="school"
        ...
        <ChartCard title="Term Performance" description="Financial reporting terms, including July and August in Term 3.">
          <DashboardBarChart
            data={termData}
            categoryKey="term"
            series={financialSeries}
      ...
      <ChartCard
        title="Monthly Trend"
        description={`${trendMetric} by month for the selected reporting scope.`}
          ...
          series={[
            {
              key: trendDataKey,
              label: trendMetric,
              tone: trendMetric === "Sales" ? "primary" : "secondary",
            },
          ]}
          formatAxis={formatCompactCurrency}
          tooltipContent={currencyTooltip}

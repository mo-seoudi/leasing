...
export default function SettingsPage() {
  ...
  const { vatDisplayBasis, setVatDisplayBasis } = useFinancialPreferences();
  ...
  async function handleSignOut() {
    ...
    if (error) { console.error("Unable to sign out:", error); setSigningOut(false); return; }
    ...
    <section className="settings-page">
      <div className="settings-card financial-preferences-card">
        <div className="settings-card-header">
          ...
          <p>Set how monetary figures are presented across ComOps. This does not change the original amounts stored in financial records.</p>
        </div>
        <div className="financial-preference-row">
          <div className="financial-preference-copy">
            <strong>VAT Display Basis</strong>
            <span>Dashboards and future exported reports use this presentation basis. Finance reporting defaults to excluding VAT.</span>
          </div>
      ...
      <div className="settings-card">
        ...
        <div className="settings-details">
          <div className="settings-detail-row"><span>Full name</span><strong>{displayName}</strong></div>
          <div className="settings-detail-row"><span>Email</span><strong>{email}</strong></div>
          <div className="settings-detail-row"><span>Role</span><strong>{formatRole(role)}</strong></div>
        </div>
